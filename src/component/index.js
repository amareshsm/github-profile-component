...
class Profile extends Component {
  ...
  pageCalculation = () => {
    ...
    const currentPosts = repoData.slice(
      indexOfFirstPost,
      indexOfLastPost,
    )
  ...
  fetchData = () => {
    ...
    if (showRepo == 'true') {
      fetch(`https://api.github.com/users/${username}/repos`)
        ...
        .then((responseJson) => {
          this.setState({ repoData: responseJson })
          this.pageCalculation()
          this.setState({ isLoadingRepo: false })
        })
        .catch((error) => {
          this.setState({
            errorMessage: error,
              ...
              <div className="GithubProfile_Card__text">
                ...
                <div className="GithubProfile_Card_Info">
                  <div className="GithubProfile_Card_Info_Item">
                    ...
                    <div className="GithubProfile_Card_Info_Text">
                      Followers
                    </div>
                  </div>
                  <div className="GithubProfile_Card_Info_Item">
